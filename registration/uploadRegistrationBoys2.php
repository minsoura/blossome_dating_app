...
$con= mysqli_connect(HOST,USER,PW,DB) or die("Unable to Connect");
		...
		$sql3= "INSERT INTO detailedInfoBoys1 (userID,userCell,userHeight,userJob,userHolding,userEmail,userAge,userPicSmall,userPicMain,userRegion,userRegion2,userUniversity,userKey,userKeyCalc) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
