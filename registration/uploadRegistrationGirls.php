...
$con= mysqli_connect(HOST,USER,PW,DB) or die("Unable to Connect");
		...
		$check2 = mysqli_stmt_affected_rows($stmt2);
			...
			$sql3= "INSERT INTO detailedInfoGirls1 (userID,userCell,userHeight,userJob,userEmail,userAge,userPicSmall,userPicMain,userRegion,userRegion2,userUniversity,userKey,userKeyCalc) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
