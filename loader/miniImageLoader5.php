...
if($userGender =="boys"){
	$sql = "SELECT userPicSmall from detailedInfoBoys1 where userEmail = '$userEmail'";
	...
	$con= mysqli_connect(HOST,USER,PW,DB) or die("Unable to Connect");
		...
		echo base64_decode($result['userPicSmall']);

} else if($userGender =="girls"){
		$sql = "SELECT userPicSmall from detailedInfoGirls1 where userEmail = '$userEmail'";
		define('HOST', "mysql.hostinger.kr");
			define('USER', "u414143907_andro");
			define('PW', "m2m3m5m2");
			define('DB', "u414143907_andro");
