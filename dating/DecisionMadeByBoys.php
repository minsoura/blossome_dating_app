...
//remove the dateEmail in the LIKEDBY section according to users' decision
		$sql0 = "SELECT LikedBy,Connected from detailedInfoBoys1 where userEmail = '$userEmail'";
...
/////////////////////COnnected here 
    ...
    $sql ="UPDATE detailedInfoBoys1 SET LikedBy=?,Connected=? WHERE userEmail=?";
...
//Girl'sTable ---->LikedBY
	...
	$sql2 = "SELECT Liking,Connected from detailedInfoGirls1 where userEmail = '$dateEmail'";
...
///////////////////
 	...
 	$messageChecker="yes";
    $sql3 ="UPDATE detailedInfoGirls1 SET Liking=?,Connected=?,messageListener=? WHERE userEmail=?";
