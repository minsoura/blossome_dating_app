...
date_default_timezone_set("Asia/Seoul");
    ...
    $con= mysqli_connect(HOST,USER,PW,DB) or die("Unable to Connect");
		...
		$sql2 ="SELECT * from detailedInfoBoys1 where ".$appendedSql." userHolding ='$holdingStatus' && userAge between '$cardAge' and '$ageIdentifier' && userRegion ='$cardRegion' order by RAND() LIMIT 2 ";
		...
		while($SelectedRows= mysqli_fetch_array($ready2, MYSQLI_ASSOC)){
  		  ...
  		  $sql ="UPDATE detailedInfoGirls1 SET userDateMet=?, userDateToday=? WHERE userEmail=?";
