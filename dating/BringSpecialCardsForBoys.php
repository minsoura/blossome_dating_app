<?php
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
	    ...
	    if($cardUniv=="NONE" && $cardHeight=="NONE" && $cardHot !=="NONE"){
				...
				$sql2 ="SELECT * from detailedInfoGirls1 where ".$appendedSql." userHolding ='$holdingStatus' && userAge between '$cardAge' and '$ageIdentifier' && userRegion ='$cardRegion' && userBeauty between 8 AND 10 order by RAND() LIMIT 2 ";
		...
		$keyOperator = 15;
	    	...
	    	$cardHeight = $cardHeight -2;
	   		...
	   		$sql2 ="SELECT *  from detailedInfoGirls1 where ".$appendedSql."  userHolding ='$holdingStatus' && userAge between '$cardAge' and '$ageIdentifier' && userRegion ='$cardRegion' &&  userHeight between '$cardHeight' and '$cardHeight2'  order by RAND() LIMIT 2 ";
			$ready2 = mysqli_query($con,$sql2);
			$family=array();
			$finalArray =array();				
			while($SelectedRows= mysqli_fetch_array($ready2, MYSQLI_ASSOC)){
	    	...
	    	$sql2 ="SELECT * from detailedInfoGirls1 where ".$appendedSql."  userHolding ='$holdingStatus' && userAge between '$cardAge' and '$ageIdentifier' && userRegion ='$cardRegion' && userUniversity = '$cardUniv'  order by RAND() LIMIT 2 ";
			$ready2 = mysqli_query($con,$sql2);
			$family=array();
			$finalArray =array();				
			while($SelectedRows= mysqli_fetch_array($ready2, MYSQLI_ASSOC)){
			...
			$keyOperator = 5;
	    		...
	    		$sql2 ="SELECT *  from detailedInfoGirls1 where ".$appendedSql."  userHolding ='$holdingStatus' && userAge between '$cardAge' and '$ageIdentifier' && userRegion ='$cardRegion' &&  userHeight between '$cardHeight' and '$cardHeight2' && userBeauty between 8 AND 10  order by RAND() LIMIT 2 ";
				$ready2 = mysqli_query($con,$sql2);
	 	   		$family=array();
				$finalArray =array();
		...
		while($SelectedRows= mysqli_fetch_array($ready2, MYSQLI_ASSOC)){
	    	...
	    	$cardHeight = $cardHeight -2;
	    	 ...
	    	 $sql2 ="SELECT *  from detailedInfoGirls1 where ".$appendedSql."  userHolding ='$holdingStatus' && userAge between '$cardAge' and '$ageIdentifier' && userRegion ='$cardRegion' &&  userHeight between '$cardHeight' and '$cardHeight2' &&  userUniversity = '$cardUniv' order by RAND() LIMIT 2 ";
			$ready2 = mysqli_query($con,$sql2);	
			$family=array();
			$finalArray =array();	
			...
			$keyOperator = 7;
	    	 ...
	    	 $sql2 ="SELECT * from detailedInfoGirls1 where ".$appendedSql."  userHolding ='$holdingStatus' && userAge between '$cardAge' and '$ageIdentifier' && userRegion ='$cardRegion' && userBeauty between 8 AND 10 &&  userUniversity = '$cardUniv' order by RAND() LIMIT 2 ";
			$ready2 = mysqli_query($con,$sql2);
			$family=array();
			$finalArray =array();	
	    	...
	    	$cardHeight = $cardHeight -2;
	     	...
	     	$sql2 ="SELECT * from detailedInfoGirls1 where ".$appendedSql."  userHolding ='$holdingStatus' && userAge between '$cardAge' and '$ageIdentifier' && userRegion ='$cardRegion' &&  userHeight between '$cardHeight' and '$cardHeight2' &&  userUniversity = '$cardUniv' && userBeauty between 8 AND 10 order by RAND() LIMIT 2 ";
			$ready2 = mysqli_query($con,$sql2);
			$family=array();
			$finalArray =array();	
		...
		while($SelectedRows= mysqli_fetch_array($ready2, MYSQLI_ASSOC)){
		  ...
		  if($setVerifier == "exists"){
  		  ...
  		  $sql ="UPDATE detailedInfoBoys1 SET userKeyCalc=?, userKey=?, userDateMet=?, userDateToday=? WHERE userEmail=?";
