<?php
    ...
    $sql ="UPDATE detailedInfoBoys1 SET userSayHi=?, userAge=?,userRegion=?,userRegion2=? WHERE userEmail=?";
    ...
    $sql1 ="UPDATE detailedInfoBoys1 SET  userPicMain=?,userPicSmall=? WHERE userEmail=?";
    ...
    $sql2 ="UPDATE detailedInfoBoys1 SET  userPicTwo=? WHERE userEmail=?";
    ...
    $sql3 ="UPDATE detailedInfoBoys1 SET  userPicThree=? WHERE userEmail=?";
    ...
    $sql4 ="UPDATE detailedInfoBoys1 SET  userPicFour=? WHERE userEmail=?";
    ...
    $sql5 ="UPDATE detailedInfoBoys1 SET  userPicFive=? WHERE userEmail=?";
