...
//remove the dateEmail in the LIKEDBY section according to users' decision
		$sql0 = "SELECT Connected,userKey,userKeyCalc from detailedInfoBoys1 where userEmail = '$userEmail'";
    ...
    $sql ="UPDATE detailedInfoBoys1 SET Connected=?,userKey=?,userKeyCalc=?  WHERE userEmail=?";
...
//Girl'sTable ---->LikedBY
	...
	$sql2 = "SELECT Connected from detailedInfoGirls1 where userEmail = '$dateEmail'";
...
///////////////////
 	...
 	$messageChecker="yes";
    $sql3 ="UPDATE detailedInfoGirls1 SET Connected=?,messageListener=? WHERE userEmail=?";
