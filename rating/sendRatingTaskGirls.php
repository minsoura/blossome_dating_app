	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		define('HOST', "mysql.hostinger.kr");
			...
			$RegisteredTime = date("Ymd");
	 		...
	 		$sql0 = "SELECT userBeautyCalc from detailedInfoBoys1 where userEmail = '$dateEmail'";
...
//////////////////////////////////////////
  		  ...
  		  $sql ="UPDATE detailedInfoBoys1 SET userBeautyCalc=?, userBeauty=? WHERE userEmail=?";
...
/////////////////////////////
	 		...
	 		$sqlKey = "SELECT userKeyCalc, userDateToday from detailedInfoGirls1 where userEmail = '$userEmail'";
  		  ...
  		  $sqlKK ="UPDATE detailedInfoGirls1 SET userKeyCalc=?, userKey=?,userDateToday=? WHERE userEmail=?";
