	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		$userEmail = $_POST['userEmail'];	
			...
			$con= mysqli_connect(HOST,USER,PW,DB) or die("Unable to Connect");
  		    ...
  		    $sql ="DELETE FROM detailedInfoGirls1 WHERE userEmail='$userEmail'";
		    $check = mysqli_query($con,$sql);



  		   	$sql2 ="DELETE FROM accountInfoGirls WHERE userEmail='$userEmail'";
		   	$check2 = mysqli_query($con,$sql2);


  		    $sql3 ="DELETE FROM preferenceForGirls WHERE userEmail='$userEmail'";
